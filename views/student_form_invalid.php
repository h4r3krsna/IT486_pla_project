            ...
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control <?php if(!$_POST['ok-student-id']) echo "errorField"; ?>" id="student-id" name="student-id" placeholder="XXXXXXXXX" required value="<?php if($_POST['ok-student-id']) echo $_POST['student-id']; ?>">
                    </div>
                    <div class="form-group">
