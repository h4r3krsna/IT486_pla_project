            ...
            <div class="col-xs-12">
                <div class="form-group">
                    <fieldset>
                        ...
                        <textarea class="form-control" id="reflection0" name="reflection0" rows="11" required></textarea>
                        ...
                        <textarea class="form-control" id="reflection1" name="reflection1" rows="11" required></textarea>
                        ...
                        <textarea class="form-control" id="reflection2" name="reflection2" rows="11" required></textarea>
                        ...
                        <textarea class="form-control" id="reflection3" name="reflection3" rows="11" required></textarea>
                        ...
                        <textarea class="form-control" id="reflection4" name="reflection4" rows="11" required></textarea>
                    </fieldset>
                </div>
            </div>
        </div>
